...
public class CE_IntrdcMain extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.ce_intrdc_main);

        Log.d("CE_IntrdcMain","----------------------------");

        tabLayout = (TabLayout) findViewById(R.id.ce_tabLayout);
        tabLayout.addTab(tabLayout.newTab().setText("인사말"));
        tabLayout.addTab(tabLayout.newTab().setText("센터소개"));
        ...
        CE_PagerAdapter pagerAdapter = new CE_PagerAdapter(getSupportFragmentManager(), tabLayout.getTabCount());
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_settings) {
            ...
            ce_alertbox = new AlertDialog.Builder(CE_IntrdcMain.this);
            ...
            sw1.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
                ...
                public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                    ...
                    if (isChecked == true) {
                        ...
                        Toast.makeText(CE_IntrdcMain.this, "블루투스 켜짐", Toast.LENGTH_SHORT).show();
                        ...
                        Toast.makeText(CE_IntrdcMain.this, "블루투스 꺼짐", Toast.LENGTH_SHORT).show();
            ...
            sw2.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
                ...
                public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                    ...
                    if (isChecked == true) {
                        ...
                        Toast.makeText(CE_IntrdcMain.this, "푸시 켜짐", Toast.LENGTH_SHORT).show();
                        Log.d("Jinwoo","isChecked == true");
                    } else { // OFF
                        ...
                        Toast.makeText(CE_IntrdcMain.this, "푸시 꺼짐", Toast.LENGTH_SHORT).show();
                        Log.d("Jinwoo","isChecked == false");
                    }
                }
            });
