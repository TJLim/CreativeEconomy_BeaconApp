...
public class CE_Facility extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.ce_facility);

        Log.d("CE_Facility","----------------------------");

        tabLayout = (TabLayout) findViewById(R.id.ce_facility_tab);
        tabLayout.addTab(tabLayout.newTab().setText("J-Space"));
        tabLayout.addTab(tabLayout.newTab().setText("예약하기"));
        tabLayout.addTab(tabLayout.newTab().setText("장비소개"));
        ...
        CE_F_PagerAdapter pagerAdapter = new CE_F_PagerAdapter(getSupportFragmentManager(), tabLayout.getTabCount());
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_settings) {
            ...
            ce_alertbox = new AlertDialog.Builder(CE_Facility.this);
            ...
            sw1.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
                ...
                public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                    ...
                    if (isChecked == true) {
                        ...
                        Toast.makeText(CE_Facility.this, "블루투스 켜짐", Toast.LENGTH_SHORT).show();
                        ...
                        Toast.makeText(CE_Facility.this, "블루투스 꺼짐", Toast.LENGTH_SHORT).show();
            ...
            sw2.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
                ...
                public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                    ...
                    if (isChecked == true) {
                        ...
                        Toast.makeText(CE_Facility.this, "푸시 켜짐", Toast.LENGTH_SHORT).show();
                        Log.d("Jinwoo","isChecked == true");
                    } else { // OFF
                        ...
                        Toast.makeText(CE_Facility.this, "푸시 꺼짐", Toast.LENGTH_SHORT).show();
                        Log.d("Jinwoo","isChecked == false");
                    }
                }
            });
