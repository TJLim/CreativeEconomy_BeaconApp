...
public class JM_IntrdcMain extends AppCompatActivity {

    ActionBar actionBar;

    private TabLayout tabLayout;
    private ViewPager jmViewPager;

    AlertDialog.Builder jm_alertbox;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.jm_intrdc_main);
        setTitle("중문관광단지");

        tabLayout = (TabLayout) findViewById(R.id.jm_intrdc_tab);
        tabLayout.addTab(tabLayout.newTab().setText("관광단지 소개"));
        tabLayout.addTab(tabLayout.newTab().setText("이용안내"));
        tabLayout.addTab(tabLayout.newTab().setText("관광안내센터"));
        tabLayout.setTabGravity(TabLayout.GRAVITY_FILL);

        // Initializing ViewPager
        jmViewPager = (ViewPager) findViewById(R.id.jm_pager);

        // Creating TabPagerAdapter adapter
        JM_PagerAdapter pagerAdapter = new JM_PagerAdapter(getSupportFragmentManager(), tabLayout.getTabCount());
        jmViewPager.setAdapter(pagerAdapter);
        jmViewPager.addOnPageChangeListener(new TabLayout.TabLayoutOnPageChangeListener(tabLayout));
        ...
        tabLayout.addOnTabSelectedListener(new TabLayout.OnTabSelectedListener() {
            ...
            public void onTabSelected(TabLayout.Tab tab) {
                jmViewPager.setCurrentItem(tab.getPosition());
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_settings) {
            ...
            jm_alertbox = new AlertDialog.Builder(JM_IntrdcMain.this);
            jm_alertbox.setCancelable(false);
            //jm_alertbox.setIcon(R.drawable.icon_24_2);
            jm_alertbox.setTitle(Html.fromHtml("<font color='#6D5652'>비콘 신호 수신 설정</font>"));
            jm_alertbox.setView(linear);
            jm_alertbox.setNegativeButton("닫기", null);
            ...
            sw1.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
                ...
                public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                    ...
                    if (isChecked == true) {
                        ...
                        Toast.makeText(JM_IntrdcMain.this, "블루투스 켜짐", Toast.LENGTH_SHORT).show();
                        ...
                        Toast.makeText(JM_IntrdcMain.this, "블루투스 꺼짐", Toast.LENGTH_SHORT).show();
            ...
            sw2.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
                ...
                public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                    ...
                    if (isChecked == true) {
                        ...
                        Toast.makeText(JM_IntrdcMain.this, "푸시 켜짐", Toast.LENGTH_SHORT).show();
                        Log.d("Jinwoo","isChecked == true");
                    } else { // OFF
                        ...
                        Toast.makeText(JM_IntrdcMain.this, "푸시 꺼짐", Toast.LENGTH_SHORT).show();
                        Log.d("Jinwoo","isChecked == false");
                    }
                }
            });

            AlertDialog alertDialog = jm_alertbox.create();
