...
public class JM_Map extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        try {
            Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("daummaps://route?sp=" + lat + "," + lon + "&ep=33.248911,126.412429&by=CAR"));
            startActivity(intent);
            JM_Tab.tabHost.setCurrentTab(0);
        } catch (Exception e) {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_settings) {
            ...
            ce_alertbox = new AlertDialog.Builder(JM_Map.this);
            ...
            sw1.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
                ...
                public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                    ...
                    if (isChecked == true) {
                        ...
                        Toast.makeText(JM_Map.this, "블루투스 켜짐", Toast.LENGTH_SHORT).show();
                        ...
                        Toast.makeText(JM_Map.this, "블루투스 꺼짐", Toast.LENGTH_SHORT).show();
            ...
            sw2.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
                ...
                public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                    ...
                    if (isChecked == true) {
                        ...
                        Toast.makeText(JM_Map.this, "푸시 켜짐", Toast.LENGTH_SHORT).show();
                        Log.d("Jinwoo","isChecked == true");
                    } else { // OFF
                        ...
                        Toast.makeText(JM_Map.this, "푸시 꺼짐", Toast.LENGTH_SHORT).show();
                        Log.d("Jinwoo","isChecked == false");
                    }
                }
            });
    ...
    protected void onDestroy() {
        ...
        Log.d("Jinwoo", "JM_Map => onDestroy 호출");
    ...
    protected void onPause() {
        ...
        Log.d("Jinwoo", "JM_Map => onPause 호출");
        mapStart = true;

        final Intent intent = new Intent(Intent.ACTION_SYNC, null, this, BackgroundService.class);
        intent.putExtra("PageNm", "CE_MAIN");
        startService(intent);
        Log.d("Jinwoo", "JM_Map => startService111111111111");
    ...
    protected void onResume() {
        ...
        Log.d("Jinwoo", "JM_Map => onResume 호출");

        if (mapStart == true){
            Intent intent = new Intent(JM_Map.this, JM_Tab.class);
            startActivity(intent);
            finish();
