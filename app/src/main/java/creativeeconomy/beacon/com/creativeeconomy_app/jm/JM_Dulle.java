...
public class JM_Dulle extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.jm_dulle);
        setTitle("중문관광단지");

        Log.d("CE_Facility","----------------------------");

        tabLayout = (TabLayout) findViewById(R.id.jm_dulle_tab);
        tabLayout.addTab(tabLayout.newTab().setText("둘레길 1코스"));
        tabLayout.addTab(tabLayout.newTab().setText("둘레길 2코스"));
        ...
        JM_D_PagerAdapter pagerAdapter = new JM_D_PagerAdapter(getSupportFragmentManager(), tabLayout.getTabCount());
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_settings) {
            ...
            ce_alertbox = new AlertDialog.Builder(JM_Dulle.this);
            ...
            sw1.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
                ...
                public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                    ...
                    if (isChecked == true) {
                        ...
                        Toast.makeText(JM_Dulle.this, "블루투스 켜짐", Toast.LENGTH_SHORT).show();
                        ...
                        Toast.makeText(JM_Dulle.this, "블루투스 꺼짐", Toast.LENGTH_SHORT).show();
            ...
            sw2.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
                ...
                public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                    ...
                    if (isChecked == true) {
                        ...
                        Toast.makeText(JM_Dulle.this, "푸시 켜짐", Toast.LENGTH_SHORT).show();
                        Log.d("Jinwoo","isChecked == true");
                    } else { // OFF
                        ...
                        Toast.makeText(JM_Dulle.this, "푸시 꺼짐", Toast.LENGTH_SHORT).show();
                        Log.d("Jinwoo","isChecked == false");
                    }
                }
            });
