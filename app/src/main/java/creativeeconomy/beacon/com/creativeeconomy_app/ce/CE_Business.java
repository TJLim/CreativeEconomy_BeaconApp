...
public class CE_Business extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.ce_business);
        ...
        tabLayout = (TabLayout) findViewById(R.id.ce_business_tab);
        tabLayout.addTab(tabLayout.newTab().setText("스마트관광"));
        tabLayout.addTab(tabLayout.newTab().setText("스마트공장"));
        tabLayout.addTab(tabLayout.newTab().setText("뷰티·헬스기업 성장 지원"));
        tabLayout.addTab(tabLayout.newTab().setText("6차 산업화지원"));
        tabLayout.addTab(tabLayout.newTab().setText("아트토이"));
        tabLayout.addTab(tabLayout.newTab().setText("제주레시피콘서트"));
        ...
        CE_B_PagerAdapter pagerAdapter = new CE_B_PagerAdapter(getSupportFragmentManager(), tabLayout.getTabCount());
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_settings) {
            ...
            ce_alertbox = new AlertDialog.Builder(CE_Business.this);
            ...
            sw1.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
                ...
                public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                    ...
                    if (isChecked == true) {
                        ...
                        Toast.makeText(CE_Business.this, "블루투스 켜짐", Toast.LENGTH_SHORT).show();
                        ...
                        Toast.makeText(CE_Business.this, "블루투스 꺼짐", Toast.LENGTH_SHORT).show();
            ...
            sw2.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
                ...
                public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                    ...
                    if (isChecked == true) {
                        ...
                        Toast.makeText(CE_Business.this, "푸시 켜짐", Toast.LENGTH_SHORT).show();
                        Log.d("Jinwoo","isChecked == true");
                    } else { // OFF
                        ...
                        Toast.makeText(CE_Business.this, "푸시 꺼짐", Toast.LENGTH_SHORT).show();
                        Log.d("Jinwoo","isChecked == false");
                    }
                }
            });
